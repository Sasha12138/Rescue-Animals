...
<div class="lists" :style='{"padding":"40px 7% 100px","margin":"0 auto","textAlign":"center","background":"#f4f4f4","display":"block","width":"100%","position":"relative"}'>
	...
	<div class="title" :style='{"margin":"20px auto 40px","alignItems":"flex-start","background":"url(http://codegen.caihongy.cn/20230130/2d385bca38bb476596d3946973a96593.png) no-repeat center bottom","display":"flex","width":"auto","position":"relative","justifyContent":"center"}'>
	  <span :style='{"fontSize":"32px","color":"#202020","fontWeight":"bold","height":"76px"}'>动物找家展示</span>
	</div>
	...
	<div class="list list3 index-pv1">
		<div class="swiper-container" id="listsdongwuzhaojia" :style='{"width":"100%","padding":"100px 40px","borderRadius":"16px","background":"linear-gradient(90deg, rgba(151,36,152,1) 0%, rgba(32,173,158,1) 100%)","height":"auto"}'>
			<div class="swiper-wrapper">
				<div class="swiper-slide animation-box" :style='{"border":"0","fontSize":"0","position":"relative","borderRadius":"4px","background":"none"}' v-for="(item,index) in dongwuzhaojiaList" :key="index" @click="toDetail('dongwuzhaojiaDetail', item)">
					<img :name="item.id" :style='{"border":"0","padding":"20px","margin":"0 0 10px","objectFit":"contain","background":"url(http://codegen.caihongy.cn/20230130/d254b3d5ad3f44648d9c986526c6f303.png) no-repeat center top / 100% 100%","width":"calc(100% - 20px)","height":"250px"}' v-if="preHttp(item.tupian)" :src="item.tupian.split(',')[0]" alt="" />
					<img :name="item.id" :style='{"border":"0","padding":"20px","margin":"0 0 10px","objectFit":"contain","background":"url(http://codegen.caihongy.cn/20230130/d254b3d5ad3f44648d9c986526c6f303.png) no-repeat center top / 100% 100%","width":"calc(100% - 20px)","height":"250px"}' v-else :src="baseUrl + (item.tupian?item.tupian.split(',')[0]:'')" alt="" />
					<div class="name line1" :style='{"padding":"0 10px","margin":"0 auto 10px","color":"#333","borderRadius":"20px","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","width":"90%","fontSize":"14px","lineHeight":"40px"}'>{{item.dongwunicheng}}</div>
					<div class="name line1" :style='{"padding":"0 10px","margin":"0 auto 10px","color":"#333","borderRadius":"20px","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","width":"90%","fontSize":"14px","lineHeight":"40px"}'>{{item.dongwuzhonglei}}</div>
					<div class="name line1" :style='{"padding":"0 10px","margin":"0 auto 10px","color":"#333","borderRadius":"20px","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","width":"90%","fontSize":"14px","lineHeight":"40px"}'>{{item.zhuangtai}}</div>
            </div>
        </div>
			<!-- 如果需要导航按钮 -->
...
<div class="lists" :style='{"padding":"40px 7% 100px","margin":"0 auto","textAlign":"center","background":"#f4f4f4","display":"block","width":"100%","position":"relative"}'>
	...
	<div class="title" :style='{"margin":"20px auto 40px","alignItems":"flex-start","background":"url(http://codegen.caihongy.cn/20230130/2d385bca38bb476596d3946973a96593.png) no-repeat center bottom","display":"flex","width":"auto","position":"relative","justifyContent":"center"}'>
	  <span :style='{"fontSize":"32px","color":"#202020","fontWeight":"bold","height":"76px"}'>动物百科展示</span>
	</div>
	...
	<!-- 样式三 -->
	<div class="list list3 index-pv1">
		<div class="swiper-container" id="listsdongwubaike" :style='{"width":"100%","padding":"100px 40px","borderRadius":"16px","background":"linear-gradient(90deg, rgba(151,36,152,1) 0%, rgba(32,173,158,1) 100%)","height":"auto"}'>
			<div class="swiper-wrapper">
				<div class="swiper-slide animation-box" :style='{"border":"0","fontSize":"0","position":"relative","borderRadius":"4px","background":"none"}' v-for="(item,index) in dongwubaikeList" :key="index" @click="toDetail('dongwubaikeDetail', item)">
					...
					<div class="name line1" :style='{"padding":"0 10px","margin":"0 auto 10px","color":"#333","borderRadius":"20px","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","width":"90%","fontSize":"14px","lineHeight":"40px"}'>{{item.biaoti}}</div>
					<div class="name line1" :style='{"padding":"0 10px","margin":"0 auto 10px","color":"#333","borderRadius":"20px","background":"linear-gradient(0deg, rgba(238,177,238,1) 0%, rgba(165,228,222,1) 30%, rgba(165,228,222,1) 100%)","width":"90%","fontSize":"14px","lineHeight":"40px"}'>{{item.dongwuzhonglei}}</div>
            </div>
        </div>
			<!-- 如果需要导航按钮 -->
	...
	<div @click="moreBtn('dongwubaike')" :style='{"border":"0","margin":"0 0 0 -100px","borderRadius":"30px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230130/900bb2bf212e4ef8a599ed8502aa2b9d.png) no-repeat 90% center,#20ad9e","bottom":"80px","display":"inline-block","width":"auto","lineHeight":"44px","minWidth":"200px","position":"absolute","zIndex":"99"}'>
		<span :style='{"color":"#f5f5f5","fontSize":"14px"}'>查看更多</span>
		<i v-if="true" :style='{"color":"#f5f5f5","fontSize":"12px","display":"none"}' class="el-icon-d-arrow-right"></i>
	</div>
...
<div class="news" :style='{"width":"56%","margin":"0 7%","position":"relative","flexWrap":"wrap","background":"none","display":"flex"}'>
	...
	<div class="title" :style='{"margin":"30px auto 20px","alignItems":"center","textAlign":"center","background":"none","display":"flex","width":"100%","position":"relative","justifyContent":"flex-start","height":"50px"}'>
		<span :style='{"fontSize":"32px","lineHeight":"60px","color":"#202020","fontWeight":"bold","height":"60px"}'>动物新闻</span>
	</div>
      ...
      getSystemIntroduction() {
		...
		getList() {
          let autoSortUrl = "";
			...
			this.$http.get('dongwuzhaojia/list', {params: {
				sfsh: '是',
				sort : 'fabushijian',
				order: 'desc',
				page: 1,
				...
				if (res.data.code == 0) {
					this.dongwuzhaojiaList = res.data.data.list;
					...
					this.$nextTick(() => {
						new Swiper ('#listsdongwuzhaojia', options)
					})
			...
			this.$http.get('dongwubaike/list', {params: {
				sort : 'fabushijian',
				order: 'desc',
				page: 1,
				limit: 8,
				...
				if (res.data.code == 0) {
					this.dongwubaikeList = res.data.data.list;
					let options = {"observer":true,"navigation":{"nextEl":".swiper-button-next","prevEl":".swiper-button-prev"},"observeParents":true,"loop":true,"slidesPerView":5,"speed":500,"spaceBetween":40,"autoplay":{"delay":3000,"disableOnInteraction":false}}
					options.pagination = {el:'null'}
					if(options.slidesPerView) {
						options.slidesPerView = Number(options.slidesPerView);
					...
					this.$nextTick(() => {
						new Swiper ('#listsdongwubaike', options)
					})
